...
<div class="row">
 <div class="col-lg-12">
  <div class="panel panel-default">
     ...
     <div class="form-group">
       <label>글</label><textarea class="form-control" rows="3" name="content" readonly="readonly">
     ...
     <div class="form-group">
      ...
      <c:if test="${member.nicname == board.writer }">
     ...
     <form id='operForm' action="/board/modify2" method="get">
          ...
          <!-- <li class="left clearfix" data-rno='12'>
            <div>
              <div class="header">
                ...
                <small class="pull-right text-muted">2021-04-16 14:14</small>
              </div>
              <p>Good job!</p>
            </div>
          </li> -->
   ...
   <div class="modal-dialog">
     <div class="modal-content">
       <div class="modal-header">
         ...
         <h4 class="modal-title" id="myModalLabel">댓 글 창</h4>
       </div>
        <div class="modal-body">
          ...
          <div class="form-group">
           <label>작 성 자</label>
           <input class="form-control" name="replyer" value="${member.nicname}" readonly="readonly">
          </div>
          <div class="form-group">
            <label>댓글 날짜</label>
        ...
        <div class="modal-footer">        
         ...
         <button id='modalRegisterBtn' type="button" class="btn btn-primary">댓글쓰기</button>    
...
$(document).ready(function(){
	...
	(function(){
		...
		$.getJSON("/board/getAttachList2", {bno:bno},function(arr){
			console.log(arr);
			var str="";
...
<script type="text/javascript">
  $(document).ready(function(){
	  ...
	  $("button[data-oper='modify']").on("click",function(e){
		  operForm.attr("action","/board/modify2").submit();
	  });
	  $("button[data-oper='list']").on("click",function(e){
		 operForm.find("#bno").remove();
		 operForm.attr("action","/board/list2");
		 operForm.submit();
	  });  
  });
</script>
